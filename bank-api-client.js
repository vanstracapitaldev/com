...
class BankAPIClient {
  ...
  async signup(userData) {
    // Accept either individual params or userData object
    let payload;
    if (typeof userData === 'string') {
      // Legacy: signup(fullName, email, password, phone)
      const [fullName, email, password, phone] = arguments;
      payload = { fullName, email, password, phone };
    } else {
      // New: signup(userData object with all fields)
      payload = userData;
    }
